...
export const PortafolioDiseñoGrafico = () => {
  return (
    <>
    <h1 className="diseñoGraficoHabilidad text-center text-2xl font-bold mt-12 mb-4">
        Diseño gráfico
      </h1>
      ...
      <div className="flex justify-center mx-5 mt-6">
        ...
        <div className="flex flex-col">
          <div className="w-auto mx-10 mb-3">
            <img src={PiezaAncheta} />
          </div>
